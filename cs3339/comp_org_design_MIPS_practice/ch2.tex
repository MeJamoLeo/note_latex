...
%=============================================================================
\newpage
\section{Chapter 2 Exercises [350]}
...
\texttt{i}, and \texttt{j} are assigned to registers \texttt{\$s0} through
\texttt{\$s4}. Assume that the base addresses of the arrays \texttt{A} and
...
%-----------------------------------------------------------------------------
\subsection{[10] MIPS to C: Array Code}
...
%-----------------------------------------------------------------------------
\subsection{[5] Instruction Format Fields}
...
\begin{enumerate}
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.10.1}
  \item[{[5] 2.10.1}] What is the value of \texttt{\$t0} for the following assembly
        code? \quad \texttt{add \$t0, \$s0, \$s1}
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.10.2}
  \item[{[5] 2.10.2}] Is the result in \texttt{\$t0} the desired result, or has
        there been overflow?
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.10.3}
  \item[{[5] 2.10.3}] For the contents of registers \texttt{\$s0} and
        \texttt{\$s1} as specified above, what is the value of \texttt{\$t0}
        for the following assembly code? \quad \texttt{sub \$t0, \$s0, \$s1}
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.10.4}
  \item[{[5] 2.10.4}] Is the result in \texttt{\$t0} the desired result, or has
        there been overflow?
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.10.5}
  \item[{[5] 2.10.5}] For the contents of registers \texttt{\$s0} and
        \texttt{\$s1} as specified above, what is the value of \texttt{\$t0}
        for the following assembly code?
        \quad \texttt{add \$t0, \$s0, \$s1} \quad followed by
        \quad \texttt{add \$t0, \$t0, \$s0}
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.10.6}
  \item[{[5] 2.10.6}] Is the result in \texttt{\$t0} the desired result, or has
        there been overflow?
\end{enumerate}
...
\begin{enumerate}
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.11.1}
  \item[{[5] 2.11.1}] For the instruction \texttt{add \$s0, \$s0, \$s1}, what is
        the range(s) of values for \texttt{\$s0} that would result in
        overflow?
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.11.2}
  \item[{[5] 2.11.2}] For the instruction \texttt{sub \$s0, \$s0, \$s1}, what is
        the range(s) of values for \texttt{\$s0} that would result in
        overflow?
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.11.3}
  \item[{[5] 2.11.3}] For the instruction \texttt{sub \$s0, \$s1, \$s0}, what is
        the range(s) of values for \texttt{\$s0} that would result in
        overflow?
\end{enumerate}
...
\begin{enumerate}
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.16.1}
  \item[{[5] 2.16.1}] How would this affect the size of each of the bit fields in
        the R-type instructions?
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.16.2}
  \item[{[5] 2.16.2}] How would this affect the size of each of the bit fields in
        the I-type instructions?
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.16.3}
  \item[{[5] 2.16.3}] How could each of two proposed changes decrease the size of
...
\begin{enumerate}
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.17.1}
  \item[{[5] 2.17.1}] What is the value of \texttt{\$t2} after the following
        instructions?
\begin{verbatim}
    sll $t2, $t0, 4
    or  $t2, $t2, $t1
\end{verbatim}
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.17.2}
  \item[{[5] 2.17.2}] What is the value of \texttt{\$t2} after the following
        instructions?
\begin{verbatim}
    srl $t2, $t0, 3
    and $t2, $t2, $t1
\end{verbatim}
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.17.3}
  \item[{[5] 2.17.3}] What is the value of \texttt{\$t2} after the following
        instructions?
\begin{verbatim}
    srl $t2, $t0, 4
    andi $t2, $t2, -1
...
%-----------------------------------------------------------------------------
\subsection{[10] Pseudoinstruction Implementation}
...
\begin{enumerate}
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.22.1}
  \item[{[5] 2.22.1}] What range of addresses can be reached using the MIPS
        ...
        executes?)
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.22.2}
  \item[{[5] 2.22.2}] What range of addresses can be reached using the MIPS branch
...
\begin{enumerate}
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.24.1}
  \item[{[5] 2.24.1}] Assume that the register \texttt{\$t1} is initialized to the
        value 10. What is the value in register \texttt{\$s2} assuming
        \texttt{\$s0} initially points to an array of integers?
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.24.2}
  \item[{[5] 2.24.2}] For the loop above, write the equivalent C code. Assume that
        the registers \texttt{\$s1}, \texttt{\$s2}, \texttt{\$t1}, and
        \texttt{\$t2} are integers \texttt{a}, \texttt{b}, \texttt{i}, and
        \texttt{temp}, respectively.
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.24.3}
  \item[{[5] 2.24.3}] For the loop above, assume that \texttt{\$t1} is initialized
...
%-----------------------------------------------------------------------------
\subsection{[10] Fibonacci in MIPS}
...
%-----------------------------------------------------------------------------
\subsection{[10] ASCII String to Integer}
...
\begin{enumerate}
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.35.1}
  \item[{[5] 2.35.1}] What value is stored at \texttt{0x10000000} on a big-endian
        machine?
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.35.2}
  \item[{[5] 2.35.2}] What value is stored at \texttt{0x10000000} on a
...
\begin{enumerate}
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.39.1}
  \item[{[5] 2.39.1}] Suppose that new, more powerful arithmetic instructions are
        ...
        design choice? Why?
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.39.2}
  \item[{[5] 2.39.2}] Suppose that we find a way to double the performance of
...
\begin{enumerate}
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.40.1}
  \item[{[5] 2.40.1}] Given the instruction mix and the assumption that an
        ...
        average CPI.
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.40.2}
  \item[{[5] 2.40.2}] For a 25\% improvement in performance, how many cycles, on
        average, may an arithmetic instruction take if load/store and branch
        instructions are not improved at all?
  \phantomsection\addcontentsline{toc}{subsubsection}{[5] 2.40.3}
  \item[{[5] 2.40.3}] For a 50\% improvement in performance, how many cycles, on
        average, may an arithmetic instruction take if load/store and branch
        instructions are not improved at all?
\end{enumerate}
