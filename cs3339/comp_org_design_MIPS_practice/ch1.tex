...
%-----------------------------------------------------------------------------
\subsection{[5] Processor Power and Capacitance}
...
\begin{enumerate}
  ...
  \item[1.9.1] For each processor find the average capacitance.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.9.2}
  \item[1.9.2] Find the percentage of the total dissipated power comprised by
  ...
  \item[1.9.3] If the total dissipated power is to be reduced by 10\%, how
...
%-----------------------------------------------------------------------------
\subsection{[10] Multiprocessor Execution Speedup}
...
\begin{enumerate}
  ...
  \item[1.10.1] Find the total execution time for this program on a 1, 2, and
  ...
  \item[1.10.2] If the time for the arithmetic instructions was reduced by
...
%-----------------------------------------------------------------------------
\subsection{[5] Wafer Yield and Cost per Die}
...
\begin{enumerate}
  ...
  \item[1.11.1] Find the yield for both wafers.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.11.2}
  \item[1.11.2] Find the cost per die for both wafers.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.11.3}
  \item[1.11.3] If the number of dies per wafer is increased by 10\% and the
        defects per area unit increases by 15\%, find the die area.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.11.4}
  \item[1.11.4] Assume a fabrication process improves the yield from 0.92 to
...
%-----------------------------------------------------------------------------
\subsection{[5] SPEC CPU2006 Benchmark Analysis}
\hypertarget{prob-1.12}{}
\noindent$\langle$\S1.6$\rangle$\medskip

\noindent The results of the SPEC CPU2006 benchmark running on an AMD Barcelona has an
instruction count of $2.389 \times 10^{12}$, an execution time of 750 s, and
a reference time of 9650.

\begin{enumerate}
  \phantomsection\addcontentsline{toc}{subsubsection}{1.12.1}
  \item[1.12.1] Find the CPI if the clock cycle time is 0.333 ns.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.12.2}
  \item[1.12.2] Find the SPECratio.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.12.3}
  \item[1.12.3] Suppose that we are developing a new version of the AMD
        Barcelona processor with a 4 GHz clock rate. We have added some
        ...
        reduced to 700 ps and the new SPECratio is 13.7. Find the new CPI.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.12.4}
  \item[1.12.4] Find the increase in CPU time if the number of instructions
        of the benchmark is increased by 10\% without affecting the CPI.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.12.5}
  \item[1.12.5] Find the increase in CPU time if the number of instructions
        of the benchmark is increased by 10\% and the CPI is reduced by 15\%
        and the CPU time by 20\%.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.12.6}
  \item[1.12.6] Find the change in the clock rate if the CPI is reduced by
        15\% and the CPU time is reduced by 20\% while the number of
        instructions is increased by 10\%.
\end{enumerate}

\problembreak % [5] ≥ 5

%-----------------------------------------------------------------------------
\subsection{[5] Performance Equation Pitfall}
...
\begin{enumerate}
  ...
  \item[1.13.1] One useful fallacy is to consider that the computer with the
  ...
  \item[1.13.2] Another fallacy is to consider that the processor executing
  ...
  \item[1.13.3] A common fallacy is to use MIPS (millions of instructions per
...
%-----------------------------------------------------------------------------
\subsection{[5] Amdahl's Law and Partial Improvement}
...
\begin{enumerate}
  ...
  \item[1.14.1] By how much is the total time reduced if the time for FP
        operations is reduced by 20\%?
  \phantomsection\addcontentsline{toc}{subsubsection}{1.14.2}
  \item[1.14.2] By how much is the time for INT operations reduced if the
        total time is reduced by 20\%?
  \phantomsection\addcontentsline{toc}{subsubsection}{1.14.3}
  \item[1.14.3] Can the total time be reduced by 20\% by reducing only the
...
%-----------------------------------------------------------------------------
\subsection{[5] CPI Optimization for Speedup}
...
\begin{enumerate}
  ...
  \item[1.15.1] By how much must we improve the CPI of FP instructions if we
        want the program to run two times faster?
  \phantomsection\addcontentsline{toc}{subsubsection}{1.15.2}
  \item[1.15.2] By how much must we improve the CPI of L/S instructions to
        make the program run two times faster?
  \phantomsection\addcontentsline{toc}{subsubsection}{1.15.3}
  \item[1.15.3] By how much is the execution time of the program improved if
