...
% Chapter 1 Exercises
%=============================================================================
\section{Chapter 1 Exercises [270]}
...
\toprule
\textbf{Desktop}   & \textbf{Year} & \textbf{Tech} & \textbf{Max.\ Clock} &
\textbf{Integer}   & \textbf{Cores} & \textbf{Max.\ DRAM} &
\textbf{SP FP}     & \textbf{L3 Cache} \\
\textbf{Processor} & & \textbf{(nm)} & \textbf{Speed (GHz)} &
\textbf{IPC/Core}  & & \textbf{BW (GB/s)} &
\textbf{(Gflop/s)} & \textbf{(MiB)} \\
\midrule
...
\midrule
\textbf{Imp./year}     & & \_\_\% & \_\_\% & \_\_\% & \_\_\% & \_\_\% & \_\_\% & \_\_\% \\
\textbf{Doubles every} & & \_\_\,yrs & \_\_\,yrs & \_\_\,yrs & \_\_\,yrs & \_\_\,yrs & \_\_\,yrs & \_\_\,yrs \\
\bottomrule
\end{tabular}
\end{center}
...
%-----------------------------------------------------------------------------
\subsection{[15] Compiler Impact on Performance}
...
%-----------------------------------------------------------------------------
\subsection{[25] Processor Power and Capacitance}
...
\begin{enumerate}
  \phantomsection\addcontentsline{toc}{subsubsection}{1.9.1~[5]}
  \item[1.9.1] [5] For each processor find the average capacitance.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.9.2~[5]}
  \item[1.9.2] [5] Find the percentage of the total dissipated power comprised by
        static power and the ratio of static power to dynamic power for each
        technology.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.9.3~[15]}
  \item[1.9.3] [15] If the total dissipated power is to be reduced by 10\%, how
...
%-----------------------------------------------------------------------------
\subsection{[15] Multiprocessor Execution Speedup}
...
\begin{enumerate}
  \phantomsection\addcontentsline{toc}{subsubsection}{1.10.1~[5]}
  \item[1.10.1] [5] Find the total execution time for this program on a 1, 2, and
        8 processor system. Also find the relative speedup of the 2 and 8
        processor system over the single processor.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.10.2~[10]}
  \item[1.10.2] [10] If the time for the arithmetic instructions was reduced by
...
%-----------------------------------------------------------------------------
\subsection{[25] Wafer Yield and Cost per Die}
...
\begin{enumerate}
  \phantomsection\addcontentsline{toc}{subsubsection}{1.11.1~[10]}
  \item[1.11.1] [10] Find the yield for both wafers.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.11.2~[5]}
  \item[1.11.2] [5] Find the cost per die for both wafers.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.11.3~[5]}
  \item[1.11.3] [5] If the number of dies per wafer is increased by 10\% and the
        defects per area unit increases by 15\%, find the die area.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.11.4~[5]}
  \item[1.11.4] [5] Assume a fabrication process improves the yield from 0.92 to
...
\begin{enumerate}
  \phantomsection\addcontentsline{toc}{subsubsection}{1.12.1~[5]}
  \item[1.12.1] [5] Find the CPI if the clock cycle time is 0.333 ns.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.12.2~[5]}
  \item[1.12.2] [5] Find the SPECratio.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.12.3~[5]}
  \item[1.12.3] [5] Find the increase in CPU time if the number of
        instructions of the benchmark is increased by 10\% without
        affecting the CPI.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.12.4~[5]}
  \item[1.12.4] [5] Find the increase in CPU time if the number of
        instructions of the benchmark is increased by 10\% and the CPI
        is increased by 5\%.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.12.5~[5]}
  \item[1.12.5] [5] Find the change in the SPECratio for this change.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.12.6~[10]}
  \item[1.12.6] [10] Suppose that we are developing a new version of the
  ...
  \phantomsection\addcontentsline{toc}{subsubsection}{1.12.7~[10]}
  \item[1.12.7] [10] This CPI value is larger than obtained in 1.12.1 as
  ...
  \phantomsection\addcontentsline{toc}{subsubsection}{1.12.8~[5]}
  \item[1.12.8] [5] By how much has the CPU time been reduced?
  \phantomsection\addcontentsline{toc}{subsubsection}{1.12.9~[10]}
  \item[1.12.9] [10] For a second benchmark, libquantum, assume an
  ...
  \phantomsection\addcontentsline{toc}{subsubsection}{1.12.10~[10]}
  \item[1.12.10] [10] Determine the clock rate required to give a further
        10\% reduction in CPU time while maintaining the number of
        instructions and with the CPI unchanged.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.12.11~[10]}
  \item[1.12.11] [10] Determine the clock rate if the CPI is reduced by
...
\begin{enumerate}
  \phantomsection\addcontentsline{toc}{subsubsection}{1.13.1~[5]}
  \item[1.13.1] [5] One useful fallacy is to consider that the computer with the
        largest clock rate also has the largest performance. Check if this is
        true for P1 and P2.
  \phantomsection\addcontentsline{toc}{subsubsection}{1.13.2~[10]}
  \item[1.13.2] [10] Another fallacy is to consider that the processor executing
  ...
  \phantomsection\addcontentsline{toc}{subsubsection}{1.13.3~[10]}
  \item[1.13.3] [10] A common fallacy is to use MIPS (millions of instructions per
...
\begin{enumerate}
  \phantomsection\addcontentsline{toc}{subsubsection}{1.14.1~[5]}
  \item[1.14.1] [5] By how much is the total time reduced if the time for FP
        operations is reduced by 20\%?
  \phantomsection\addcontentsline{toc}{subsubsection}{1.14.2~[5]}
  \item[1.14.2] [5] By how much is the time for INT operations reduced if the
        total time is reduced by 20\%?
  \phantomsection\addcontentsline{toc}{subsubsection}{1.14.3~[5]}
  \item[1.14.3] [5] Can the total time be reduced by 20\% by reducing only the
...
%-----------------------------------------------------------------------------
\subsection{[25] CPI Optimization for Speedup}
...
\begin{enumerate}
  \phantomsection\addcontentsline{toc}{subsubsection}{1.15.1~[10]}
  \item[1.15.1] [10] By how much must we improve the CPI of FP instructions if we
        want the program to run two times faster?
  \phantomsection\addcontentsline{toc}{subsubsection}{1.15.2~[10]}
  \item[1.15.2] [10] By how much must we improve the CPI of L/S instructions to
        make the program run two times faster?
  \phantomsection\addcontentsline{toc}{subsubsection}{1.15.3~[5]}
  \item[1.15.3] [5] By how much is the execution time of the program improved if
